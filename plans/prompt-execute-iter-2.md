...
## Setup
1. Load epic: npx bd show wi-tbw (immutable requirements, success criteria, anti-patterns)
...
1. Re-read epic: npx bd show wi-tbw
...
3. Check: are ALL epic success criteria now met?
   ...
   - **NO** → create the next logical task based on what you learned:
     ...
     npx bd dep add <new-task-id> wi-tbw --type parent-child
