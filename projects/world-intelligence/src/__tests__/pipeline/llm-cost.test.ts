...
describe('estimateCost — new Gemini and Haiku models', () => {
  ...
  it('returns non-zero cost for gemini-3.1-pro-preview', () => {
    const cost = estimateCost('gemini', 'gemini-3.1-pro-preview', 1_000_000, 1_000_000)
    expect(cost).toBeGreaterThan(0)
  })
  ...
  it('returns non-zero cost for claude-haiku-4-5', () => {
